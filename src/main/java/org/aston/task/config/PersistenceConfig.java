...
public class PersistenceConfig {
    ...
    private Properties hibernateProperties() {
        ...
        properties.put("jakarta.persistence.schema-generation.database.action",
                environment.getProperty("schema-generation.database.action", "none"));
        properties.put("jakarta.persistence.schema-generation.create-script-source",
                environment.getProperty("schema-generation.create-script-source"));
        return properties;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        emf.setPackagesToScan("org.aston.task");
